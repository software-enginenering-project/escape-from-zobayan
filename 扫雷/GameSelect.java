...
public class GameSelect {
    ...
    void paintSelf(Graphics g){
        ...
        g.drawString("easy", 220, 100);

        g.drawRect(100,200,300,100);
        //GameUtil.drawWord(g,"sample",220,250,30,Color.black);
        g.setFont(new Font("仿宋",Font.BOLD,30));
        g.drawString("sample", 220, 250);

        g.drawRect(100,350,300,100);
        //GameUtil.drawWord(g,"manba",220,400,30,Color.black);
        g.setFont(new Font("仿宋",Font.BOLD,30));
        g.drawString("manba", 220, 400);
    }
